 ...
 * @author mazouz
 */
public class InfoSalesMessage implements SalesMessage{
    private final String productName;
    private final int valuePerOne;
    private final int quanitity;

    public InfoSalesMessage(final Builder builder) {
    ...
    public static class Builder {
        ...
        public InfoSalesMessage build() {
            return new InfoSalesMessage(this);
        }
    }
}
